...
class Category(models.Model):
    ...
    cid = ShortUUIDField(unique=True, length=10, max_length=20, prefix="cat", alphabet="abcdefgh123defghijklmnopqrstuvwxyz")
...
class Vendor(models.Model):
    vid = ShortUUIDField(unique=True, length=10, max_length=20, prefix="ven", alphabet="abcdefgh123defghijklmnopqrstuvwxyz")
    ...
    address = models.CharField(max_length=100, default="123 Main Street, UAE.")
...
class Product(models.Model):
    pid = ShortUUIDField(unique=True, length=10, max_length=20, alphabet="abcdefgh123defghijklmnopqrstuvwxyz")
